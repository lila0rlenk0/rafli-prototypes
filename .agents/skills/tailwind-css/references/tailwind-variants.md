...
interface ButtonProps
	extends Omit<ButtonVariants, 'size'>, Required<Pick<ButtonVariants, 'size'>> {
	children: React.ReactNode;
}
```
...
const input = tv({
	...
	variants: {
		variant: {
			default:
				'border-input focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-ring',
