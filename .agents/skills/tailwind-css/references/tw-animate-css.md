...
```html
<div class="fade-in slide-in-from-bottom-4 animate-in duration-300">
...
```html
<div class="fade-out slide-out-to-bottom-4 animate-out duration-200">
...
```html
<div class="fade-in zoom-in-50 slide-in-from-bottom-8 animate-in duration-500">
