...
- domain folders: `auth`, `raffle`, `host`, `hub`, `payment`, `filters`, `promo-code`, `mode`, `order`, `fulfillment`, `notifications`, `report`, `verification`, `my-raffles`, `browse`, `profile`, `landing`, `pricing`, `subscribe`, `messages`, `admin`
