 ...
 *
 * Displays a sidebar card showing the user's profile completion progress.
 * Lists all important sections that need to be filled in with checkmarks
...
/**
 * Custom profile icon SVG component
 *
 * Displays the decorative profile icon at the top of the sidebar
 */
function ProfileIcon(props: ComponentProps<'svg'>) {
	return (
		<svg
			width="100"
			height="102"
