...
export function ReviewStep() {
	...
	/**
	 * Resolve the type-specific review section via switch on the discriminated
	 * verificationType. Only one branch renders — the union is exhaustive.
	 */
	function getTypeSpecificReview() {
