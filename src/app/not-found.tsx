	...
	return (
		<main className="bg-background relative min-h-dvh">
			...
			<nav className="bg-background sticky top-0 z-20 border-b">
				<div className="mx-auto flex h-14 w-full max-w-[1440px] items-center px-4 sm:h-16 sm:px-[100px]">
					<Link href="/browse">
			...
			<div className="relative z-20 flex min-h-[calc(100dvh-4rem)] flex-col items-center justify-center gap-6 px-4 text-center">
 ...
 * (`--color-accent-blue / green / yellow`) via Tailwind v4's auto-generated
