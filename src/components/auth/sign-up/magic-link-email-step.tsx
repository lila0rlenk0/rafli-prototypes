...
export interface SignUpMagicLinkEmailStepProps extends ComponentProps<'form'> {
	returnTo: string;
...
/** Email input step that sends a magic link — primary sign-up method */
export function SignUpMagicLinkEmailStep({
	className,
	returnTo,
	onLinkSent,
	onSwitchToPassword,
	...
	return (
		...
		>
			<FieldGroup className="mx-auto h-fit w-full max-w-80">
				...
				<Field>
					<FieldLabel htmlFor="sign-up-magic-link-email">
						Enter your email
					</FieldLabel>
					<Input
						id="sign-up-magic-link-email"
						type="email"
