...
export interface SignUpMagicLinkSentStepProps extends ComponentProps<'div'> {
	email: string;
	returnTo: string;
	onBack: () => void;
}

export function SignUpMagicLinkSentStep({
	className,
	email,
	returnTo,
	onBack,
	...props
}: SignUpMagicLinkSentStepProps) {
	...
	return (
		<div className={cn(SIGN_UP_CARD_CLASS, className)} {...props}>
			<div className="mx-auto flex h-fit w-full max-w-80 flex-col items-center gap-4">
				...
				<p className="text-muted-foreground text-sm">
					Click the link in the email to finish signing up. You can close this
					tab.
				</p>
