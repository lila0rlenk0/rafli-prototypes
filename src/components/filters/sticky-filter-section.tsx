	...
	return (
		<>
			...
			<div
				...
				className={
					isSticky
						? 'bg-background fixed top-0 left-0 z-[100] w-full border-b border-[#e6e8ec] px-2 py-3 shadow-sm sm:static sm:z-auto sm:w-auto sm:border-none sm:px-0 sm:py-0 sm:shadow-none'
						: ''
				}
			>
				{children}
