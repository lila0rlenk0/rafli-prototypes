...
export function ChatInbox({
	...
	return (
		<div className="h-page-dvh flex min-h-130 flex-col gap-3">
		...
		<div className="text-muted-foreground flex h-full flex-col items-center justify-center gap-4 px-8 py-12 text-center text-sm">
			...
			<div className="flex max-w-sm flex-col gap-2">
				...
				<p className="leading-relaxed">
					Chats open automatically when you win a sweepstakes or host one —
					winners and hosts can coordinate delivery, payment details, and
					anything else the prize needs.
				</p>
				<p className="leading-relaxed">
					Pick a conversation from the list to keep talking. You can&rsquo;t
					start a chat manually — they&rsquo;re created for you when a
					sweepstakes result makes one necessary.
				</p>
			</div>
		</div>
	);
...
function ModerationNotice() {
	...
	return (
		<p className="text-muted-foreground flex items-center justify-center gap-2 px-1 text-center text-xs/relaxed whitespace-nowrap">
