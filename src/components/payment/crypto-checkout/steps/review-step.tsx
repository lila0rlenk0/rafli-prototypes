...
import {
	formatPaymentAmount,
	formatTokenBalance,
} from '@/lib/web3/format/format';
import { getChainName } from '@/lib/web3/format/block-explorers';
...
export function ReviewStep({
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<div className="border-ink-200 rounded-2xl border p-5">
			...
			{isHydrated && isClosingSoon ? (
				<div className="rounded-xl bg-amber-50 px-4 py-3 text-center text-xs text-amber-700">
					...
					the sweepstakes ends. If settlement lands after draw start, support
					may need to review the purchase.
				</div>
			) : null}
