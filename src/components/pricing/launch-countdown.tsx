...
export function LaunchCountdown({
	...
	return (
		<section
			...
			className="bg-accent-yellow w-full rounded-3xl px-6 py-10 sm:px-10 sm:py-12"
		>
			<div className="flex flex-col items-center gap-4 text-center">
				<time
					...
					// `text-h2` treatment so the countdown reads as a single emphatic
					// block rather than a digit + caption pair.
					dateTime={endsAt}
					className="font-clash-display text-h2 font-semibold tabular-nums"
				>
					{parts.hours}:{parts.minutes}:{parts.seconds}
				</time>
				<h2 className="font-clash-display text-h2 font-semibold">
					Launch pricing ends soon!
				</h2>
				<p className="text-foreground max-w-[854px] text-base leading-[1.4] font-normal text-pretty">
				...
				<Link
					href={secondaryHref}
					className="focus-visible:ring-ring/50 rounded-sm text-sm font-medium underline underline-offset-4 hover:no-underline focus-visible:ring-[3px] focus-visible:outline-none"
				>
