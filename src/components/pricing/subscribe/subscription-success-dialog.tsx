	...
	return (
		<Dialog open={isOpen} onOpenChange={handleOpenChange}>
			<DialogContent
				...
				className="bg-brand-mint sm:max-w-card-xs overflow-hidden border-black sm:rounded-3xl sm:border-2"
			>
				{subscription ? (
					<EnrolledDialogBody
...
function EnrolledDialogBody({
	...
	return (
		<div className="relative flex flex-col gap-6 pt-2 sm:pt-4">
			...
			<span
				aria-hidden
				className="bg-brand-yellow -rotate-tilt-xs pointer-events-none absolute -top-3 -right-2 flex h-15 w-30 flex-col items-center justify-center rounded-2xl border-2 border-black sm:-top-4 sm:-right-4 sm:h-17.5 sm:w-35"
			>
				<span className="font-clash-display text-xl/none font-semibold text-black">
					MEMBER
				</span>
				{badgeText ? (
					<span className="text-2xs mt-1 font-semibold text-black">
						{badgeText}
					</span>
				) : null}
			</span>
			...
			<DialogHeader className="gap-3 text-left">
				<div className="inline-flex items-center gap-2">
					...
					<span className="tracking-micro-4 text-xs font-semibold text-black uppercase">
				...
				<DialogTitle
					...
					className="font-clash-display text-3xl/display tracking-micro-4 sm:text-40 font-semibold text-black"
				>
					You&rsquo;re in.
				</DialogTitle>
	...
	return (
		<div className="flex flex-col gap-6 pt-2 sm:pt-4">
			<DialogHeader className="gap-3 text-left">
				...
				<DialogTitle className="font-clash-display text-3xl/display tracking-micro-4 sm:text-40 font-semibold text-black">
