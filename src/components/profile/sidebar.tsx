...
export function ProfileSidebar({ items }: ProfileSidebarProps) {
	...
	return (
		<div className="sticky top-8 hidden h-fit w-71.25 shrink-0 flex-col rounded-3xl border border-black bg-white/95 py-10 pr-10 pl-8 md:flex">
					...
					{items.map(function renderItem(item) {
						return (
							...
							>
								...
								<span className="text-ink-600 text-sm/relaxed">
									{item.label}
								</span>
							</button>
						);
