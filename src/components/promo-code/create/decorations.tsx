...
/**
 * Cream/mint/yellow decorative card stack rendered behind modal content.
 * Shared across the create-promo flow so the two dialog views (form and
 * success) maintain identical art direction.
 */
export function ColoredCards(props: ComponentProps<'svg'>) {
	return (
		<svg
			width="393"
			height="234"
