...
/**
 * RaffleWonCard Component
 *
 * Displayed to users who won a concluded raffle.
 * Shows congratulations message with winner details.
 */
export function RaffleWonCard({
	userName,
	userAvatar,
	ticketCode,
	actionsSlot,
		...
		>
			...
			>
				...
				<div className="mt-4 flex flex-col gap-1 text-center">
					<span className="text-ink-500 text-sm">Winner</span>
...
function ConfettiIcon(props: ComponentProps<'svg'>) {
	return (
		<svg
			width="58"
			height="58"
