...
import { CommentSortTabs } from './sort-tabs';
...
interface CommentListBodyProps {
	isLoading: boolean;
	comments: Comment[];
	raffleId: string;
	isAuthenticated: boolean;
			...
			{hasNextPage ? (
				<div className="flex justify-center pt-2">
					<button
						...
						className="hover:bg-brand-sky rounded-full border border-black px-6 py-2 text-sm font-medium text-black transition-colors"
					>
