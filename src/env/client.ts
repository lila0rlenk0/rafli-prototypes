...
export const clientEnv = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_IPFS_GATEWAY_URL: z.url().default('https://gateway.pinata.cloud/ipfs/'),
	},
	runtimeEnv: {
		...
		NEXT_PUBLIC_VRF_CONTRACT_ADDRESS: process.env.NEXT_PUBLIC_VRF_CONTRACT_ADDRESS,
