...
describe('markDelivered', () => {
	...
	test('returns MARK_DELIVERED_FAILED on invalid response shape', async () => {
		...
		if (!result.success) {
			expect(result.error).toBe(WINNING_ERROR_CODES.MARK_DELIVERED_FAILED);
		}
	});
